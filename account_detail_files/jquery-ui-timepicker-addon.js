...
$.extend(Timepicker.prototype, {
	...
	_newInst: function($input, o) {
		...
		if (tp_inst._defaults.timezoneList === null) {
			var timezoneList = [];
			/*
			// IMS Changed to use Josh Fraser's / Jon Nylander's time-zone detector script (included below).
			for (var i = -11; i <= 12; i++)
			...
			*/
			$.each(jstz.olson.timezones, function() {
				timezoneList.push({value: this[0].replace(":", ""), label: this[1]});
			});
...
$.datepicker._gotoToday = function(id) {
	...
	if (tp_inst && tp_inst._defaults.showTimezone && tp_inst.timezone_select) {
		...
		*/			
		var tzoffset = jstz.determine_timezone().offset().replace(":","");
